    ...
    return {
        ...
        download: function(i, s) {
            ...
            if (navigator.userAgent.indexOf("MSIE 10") === -1) {
               u = new Blob([o], {type: "text/calendar;content-Disposition: attachment;charset=" + document.characterSet})
            } else {
                var a = new BlobBuilder;
                a.append(o);
                u = a.getBlob("text/calendar;content-Disposition: attachment;charset=" + document.characterSet)
            }
            saveAs(u, i + s);
            return o;
        }
