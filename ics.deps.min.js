...
var ics = function() {
    ...
    var t = [];
    var n = ["BEGIN:VCALENDAR", "PRODID:-//Google Inc//Google Calendar 70.9054//EN", "VERSION:2.0","CALSCALE:GREGORIAN", "METHOD:PUBLISH", "X-WR-CALNAME:School Calendar", "X-WR-TIMEZONE:UTC"].join(e);
    ...
    return {
        ...
        addEvent: function(n, r, i, s, o) {
            ...
            var x = f + l + c + E;
            var T = v + m + g + S;
            var N = ["BEGIN:VEVENT", "CLASS:PUBLIC", "DESCRIPTION:" + r, "DTSTART;VALUE=DATE:" + x, "DTEND;VALUE=DATE:" + T, "LOCATION:" + i, "SUMMARY;LANGUAGE=en-us:" + n, "TRANSP:TRANSPARENT", "BEGIN:VALARM", "TRIGGER:-PT5M", "REPEAT:0", "ACTION:DISPLAY", "DESCRIPTION:Reminder", "END:VALARM", "END:VEVENT"].join(e);
            t.push(N);
            return N
        },
        download: function(i, s) {
            ...
            if (navigator.userAgent.indexOf("MSIE 10") === -1) {
               u = new Blob([o], {type: "text/ical;content-Disposition: attachment;charset=" + document.characterSet})
            } else {
                var a = new BlobBuilder;
                a.append(o);
                u = a.getBlob("text/ical;content-Disposition: attachment;charset=" + document.characterSet)
            }
            saveAs(u, i + s);
            return u;
        }
