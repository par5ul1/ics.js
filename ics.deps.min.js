...
var ics = function() {
    ...
    var t = [];
    var n = ["BEGIN:VCALENDAR", "PRODID:-//Google Inc//Google Calendar 70.9054//EN", "VERSION:2.0","CALSCALE:GREGORIAN", "METHOD:PUBLISH", "X-WR-CALNAME:School Calendar", "X-WR-TIMEZONE:Rome/Italy"].join(e);
    ...
    return {
        ...
        addEvent: function(n, r, i, s, o) {
            ...
            var x = f + l + c + E;
            var T = v + m + g + S;
            var N = ["BEGIN:VEVENT", "CLASS:PUBLIC", "DESCRIPTION:" + r, "DTSTART:" + x, "DTEND:" + T, "LOCATION:" + i, "SUMMARY;LANGUAGE=en-us:" + n, "TRANSP:TRANSPARENT", "BEGIN:VALARM", "TRIGGER:-PT5M", "REPEAT:0", "ACTION:DISPLAY", "DESCRIPTION:Reminder", "END:VALARM", "END:VEVENT"].join(e);
            t.push(N);
            return N
        },
